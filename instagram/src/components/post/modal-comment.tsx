...
export default function ModalComment(props: postModalComment) {
  ...
  const commentAvatar = props.comment.avatar === undefined ? "/images/avatars/default_avatar.jpg" : "data:image/png;base64, " + props.comment.avatar.data.data
    
  return (
    <div className="items-center mt-8 flex justify-between">
      <div className="flex items-center">
        <img
          className="rounded-full h-8 w-8 wr-3"
          src={commentAvatar}
          alt=""
        />
        <div>
